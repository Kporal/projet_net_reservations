...
BEGIN
INSERT INTO cmd_vols ([client_firstname],[client_lastname],[client_address],[client_phone],[client_mail],[client_postal_code],
[client_city],[client_country],[vol_name],[vol_from],[vol_to],[vol_category],[vol_dateStart],[vol_dateEnd],[vol_price])
VALUES (@FirstName,@LastName,@Address,@Phone,@Mail,@PostalCode,@City,@Country,@Vols_name,@Vols_from,@Vols_to,@Vols_category,@Vols_DateStart, @Vols_DateEnd, @Vols_Price);
END
GO